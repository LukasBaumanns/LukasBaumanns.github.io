...
class GlowCookies {
  ...
  addCss() {
    ...
    stylesheet.setAttribute('href', 'css/glowCookies.css?v=2026-09-04');
  ...
  createDOMElements() {
    ...
    this.PreBanner.innerHTML = `<button type="button" id="prebannerBtn" class="prebanner prebanner__border__${this.config.bannerStyle} glowCookies__${this.config.position} glowCookies__${this.config.border} animation" aria-label="${this.banner.manageCookies.text}" title="${this.banner.manageCookies.text}" style="color: ${this.banner.manageCookies.color}; background-color: ${this.banner.manageCookies.background};">
                                    <svg aria-hidden="true" fill="currentColor" height="18px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    ...
    const privacyButton = document.getElementById('datenschutz')
    const privacyPanel = privacyButton && privacyButton.nextElementSibling
    if (privacyPanel) {
      privacyPanel.insertAdjacentElement('afterend', this.PreBanner)
    } else {
