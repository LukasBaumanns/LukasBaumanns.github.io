...
class GlowCookies {
  ...
  createOverlay() {
    ...
    this.overlay.id = 'glowCookiesOverlay';
    ...
    this.overlay.style.zIndex = '99998'; // Just below the cookie banner
  ...
  render() {
    ...
    this.checkStatus()
    this.overlay.style.display = 'block'; // Show the overlay when the banner is active
